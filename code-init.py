...
parser = argparse.ArgumentParser(
    prog="code-init",
    description="Init a source file with problem details from a platform along with the pdf file",
)
parser.add_argument(
    "--no",
    "-n",
...
try:
    src_file = Initiator(args.platform).generate_code(
        args.problem_no, args.lang, args.overwrite
    )
