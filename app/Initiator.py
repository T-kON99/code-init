...
class Initiator(object):
    def __init__(self, platform: str):
        ...
        assert platform in self.__platform_handler, f'Unsupported platform given {platform}'
    ...
    def generate_code(self, problem_no: int, src_lang: str, overwrite: bool = False):
        ...
        else: print(f'[INFO]: Skipping creation of file {SRC_FILE_PATH} as it already exists')
